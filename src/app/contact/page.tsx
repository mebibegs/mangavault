    ...
    <div className="min-h-screen bg-bg-primary">
      <header className="border-b border-border-subtle bg-bg-secondary/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
          ...
          <Link href="/" className="text-xs sm:text-sm text-white bg-bg-card border border-border-bright rounded-lg px-3 py-1.5 hover:bg-bg-hover transition-colors">
            ← Home
          </Link>
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-bg-card border border-border-subtle rounded-xl p-6">
            ...
            <Link href="/dmca" className="inline-flex items-center gap-1 text-sm text-white hover:underline">
