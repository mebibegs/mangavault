    ...
    <footer className="wfooter">
      <div className="wfooter-inner">
        ...
        <div className="wfooter-bottom">
          &copy; {new Date().getFullYear()} MangaVault &middot; One search across every source. All titles &amp; artwork belong to their respective creators.
        </div>
      </div>
    </footer>
  );
